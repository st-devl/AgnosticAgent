...
class HealthChecker:
    ...
    def run_all_checks(self):
        ...
        scripts = [
            ...
            ".agent/scripts/core/contract_validator.py",
            ".agent/scripts/core/tech_stack_enforcer.py",
            ".agent/scripts/core/config_enforcer.py",
            ".agent/scripts/core/secret_scanner.py",
            ".agent/scripts/core/diff_generator.py",
            ".agent/scripts/core/memory_controller.py",
        ]
